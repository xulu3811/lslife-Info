...
const iconMapping = {
    ...
    'car_carpool_car_find_person': '3d_flat_car_carpool_car.png',
    'car_carpool_goods': '3d_flat_car_carpool_goods.png',
...
// Remove existing iconUrl in leaf nodes to avoid duplicates just in case
// but carefully only remove iconUrls that are on leaf nodes.
// Let's just do a simpler search and replace for each id.
