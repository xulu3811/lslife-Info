...
src = r"C:\Users\xl246\.gemini\antigravity\brain\dae46f90-79c3-4613-b709-01137a0b6df9\.user_uploaded\media_1787408349469.png"
...
try:
    ...
    print("Removing background for new locksmith icon...")
