...
import friendRoutes from './modules/friend.js';
import appVersionRoutes from './modules/appVersion.js';
...
const apksDir = path.resolve(__dirname, '../public/apks');
...
export function createApp() {
  ...
  app.use('/api/admin', appVersionRoutes);
