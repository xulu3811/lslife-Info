...
mappings = [
    (r"C:\Users\xl246\.gemini\antigravity\brain\dae46f90-79c3-4613-b709-01137a0b6df9\.user_uploaded\media_1787450258936.jpg", "ic_category_sub_ai_coding_v2.png")
]

for src, dest in mappings:
    process_and_save(src, dest)

print("Done processing AI coding icon!")
