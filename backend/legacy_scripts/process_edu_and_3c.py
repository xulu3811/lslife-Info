...
mappings = [
    (r"C:\Users\xl246\.gemini\antigravity\brain\dae46f90-79c3-4613-b709-01137a0b6df9\.user_uploaded\media_1787456521423.jpg", "ic_category_edu.png"),
    (r"C:\Users\xl246\.gemini\antigravity\brain\dae46f90-79c3-4613-b709-01137a0b6df9\.user_uploaded\media_1787456524693.png", "ic_category_sub_3c_v2.png")
]

for src, dest in mappings:
    process_and_save(src, dest)

print("Done processing edu and 3c icons!")
