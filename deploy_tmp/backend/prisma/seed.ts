...
const categoryTreeSeed = [
  ...
  },
  {
    ...
    children: [
      { name: '日常保洁', id: 'cat_2_service_daily' },
      { name: '深度保洁', id: 'cat_2_service_deep' },
      { name: '家电清洗', id: 'cat_2_service_appliance' },
      { name: '保姆/钟点工', id: 'cat_2_service_nanny' },
      { name: '月嫂/育儿', id: 'cat_2_service_maternity' },
      { name: '陪护/看护', id: 'cat_2_service_care' },
    ]
  },
  {
    id: 'cat_3_repair',
    ...
    children: [
      { name: '水电/管道', id: 'cat_3_repair_plumbing' },
      { name: '开锁/换锁', id: 'cat_3_repair_lock' },
      { name: '家电维修', id: 'cat_3_repair_appliance' },
      { name: '房屋修缮', id: 'cat_3_repair_house' },
    ...
    for (const child of parent.children) {
      ...
      await prisma.category.create({
        data: {
          id: child.id,
          name: child.name,
          iconUrl: `android.resource://com.lianshan.lslife/drawable/ic_category_sub_${subNameEng}`,
