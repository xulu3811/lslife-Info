...
icons = {
    "car_carpool_person": "a person waiting for a car on the street, holding a sign, 3d minimal character",
    "car_carpool_car": "a car waiting for a passenger with an open door",
    "car_carpool_goods": "a car delivering packages, cardboard boxes near a car"
}
